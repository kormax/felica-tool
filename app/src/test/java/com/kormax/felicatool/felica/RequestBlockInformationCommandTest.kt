...
class RequestBlockInformationCommandTest {
    ...
    fun `test toByteArray round trip`() {
        ...
        val original = RequestBlockInformationCommand(idm, nodeCodes)

        val data = original.toByteArray()
        val parsed = RequestBlockInformationCommand.fromByteArray(data)
    ...
    fun `test fromByteArray with invalid length`() {
        ...
        try {
            RequestBlockInformationCommand.fromByteArray(data)
