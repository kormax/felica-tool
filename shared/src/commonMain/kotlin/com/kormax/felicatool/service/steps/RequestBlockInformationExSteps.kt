...
internal object RequestBlockInformationExDetermineSupportedStep :
    ...
    override suspend fun ScanSession.perform(): StepOutput {
        val response =
            executeCommand(
                attempts = supportCheckAttempts("request_block_information_ex"),
        ...
        return StepOutput(
            buildString {
                appendLine("Request Block Information Ex command is supported (response received)")
...
internal object RequestBlockInformationExDetermineTrailingDataSupportedStep :
    CommandTrailingDataSupportedScanStep<RequestBlockInformationExResponse>(
        ...
        commandKey = "request_block_information_ex",
