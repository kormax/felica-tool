...
sealed class ServiceAttribute(
    ...
    companion object {
        val entries: List<ServiceAttribute> by lazy {
            listOf(
                RandomRwWithKey,
                RandomRwWithoutKey,
                RandomRoWithKey,
                ...
                PurseRwWithKey,
                PurseRwWithoutKey,
                PurseCashbackWithKey,
                PurseCashbackWithoutKey,
                PurseDecrementWithKey,
                PurseDecrementWithoutKey,
                PurseRoWithKey,
                PurseRoWithoutKey,
                RandomRwWithKeyWithPin,
                RandomRwWithoutKeyWithPin,
                RandomRoWithKeyWithPin,
                RandomRoWithoutKeyWithPin,
                CyclicRwWithKeyWithPin,
                CyclicRwWithoutKeyWithPin,
                CyclicRoWithKeyWithPin,
                CyclicRoWithoutKeyWithPin,
                PurseRwWithKeyWithPin,
                PurseRwWithoutKeyWithPin,
                PurseCashbackWithKeyWithPin,
                PurseCashbackWithoutKeyWithPin,
                PurseDecrementWithKeyWithPin,
                PurseDecrementWithoutKeyWithPin,
                PurseRoWithKeyWithPin,
                PurseRoWithoutKeyWithPin,
            )
        }

        private val knownByValue: Map<Int, ServiceAttribute> by lazy {
